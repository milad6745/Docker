دستور `docker history` در Docker به شما این امکان را می‌دهد که تاریخچه‌ی یک تصویر Docker را بررسی کنید. این دستور اطلاعات مربوط به هر لایه (layer) در تاریخچه تصویر را نمایش می‌دهد، از جمله دستوراتی که در هر لایه اجرا شده‌اند و اندازه‌ی هر لایه.
